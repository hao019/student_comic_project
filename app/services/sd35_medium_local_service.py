...
SD35_MEDIUM_PANEL_TARGET_PIXELS = int(os.getenv("SD35_MEDIUM_PANEL_TARGET_PIXELS", "1179648"))
SD35_MEDIUM_PANEL_MAX_SIDE = int(os.getenv("SD35_MEDIUM_PANEL_MAX_SIDE", "1536"))
